    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 items-start">
          ...
          {/* Quick Links */}
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-base sm:text-lg font-semibold text-gray-300">Quick Links</h3>
            <nav aria-label="Footer navigation">
              <ul className="space-y-2">
                <li>
                  <a 
                    href="#features" 
                    className="text-sm sm:text-base text-gray-400 hover:text-blue-400 transition-colors inline-block py-1"
                ...
                <li>
                  <button 
                    ...
                    className="text-sm sm:text-base text-gray-400 hover:text-blue-400 transition-colors py-1 text-left"
          ...
          {/* Social Links */}
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-base sm:text-lg font-semibold text-gray-300">Connect With Us</h3>
            <div className="flex space-x-3 sm:space-x-4">
              <a 
                href="https://www.linkedin.com/company/mediumreach" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-blue-600 p-2.5 sm:p-3 rounded-full transition-colors group min-w-[44px] min-h-[44px] flex items-center justify-center"
                data-testid="footer-social-linkedin"
                aria-label="Visit MediumReach LinkedIn page"
              >
                <svg className="h-4 sm:h-5 w-4 sm:w-5 fill-current text-gray-400 group-hover:text-white" viewBox="0 0 24 24">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-gradient-to-br from-purple-600 to-pink-600 p-2.5 sm:p-3 rounded-full transition-colors group min-w-[44px] min-h-[44px] flex items-center justify-center"
